    ...
    <nav class="flex items-center justify-between flex-wrap bg-gray-100 p-6">
        ...
        <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
            <div class="text-sm lg:flex-grow">
                <a href="" class="block mt-4 lg:inline-block lg:mt-0 text-gray-700 hover:text-red-vibrant mr-4">
                    Posts
                </a>
                <a href="" class="block mt-4 lg:inline-block lg:mt-0 text-gray-700 hover:text-red-vibrant mr-4">
                    Projects
                </a>
                <a href="" class="block mt-4 lg:inline-block lg:mt-0 text-gray-700 hover:text-red-vibrant">
                    About
                </a>
            </div>
            <div>
